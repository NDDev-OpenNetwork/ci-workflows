...
USES_RE = re.compile(
    r"^NDDev-OpenNetwork/ci-workflows/\.github/workflows/[^@]+\.ya?ml@(<sha>|[0-9a-f]{40})$"
)
REUSABLE_RE = re.compile(
    r"^NDDev-OpenNetwork/ci-workflows/\.github/workflows/([^@]+\.ya?ml)@"
)
...
SELF_HOSTED_EXAMPLES = (
    ...
    "examples/private-paid-ghas/security-selfhosted.yml",
)
