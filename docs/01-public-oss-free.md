...
jobs:
  scorecard:
    permissions:
      ...
      contents: read
      actions: read
    uses: NDDev-OpenNetwork/ci-workflows/.github/workflows/public-scorecard.yml@<full-sha>
    with:
...
jobs:
  dependency-review:
    permissions:
      contents: read
      pull-requests: write
    uses: NDDev-OpenNetwork/ci-workflows/.github/workflows/public-dependency-review.yml@<full-sha>
    with:
