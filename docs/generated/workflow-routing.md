...
| `.github/workflows/java-ci.yml` | `portable-shell` | linux, macos, windows | shell only |
...
| `.github/workflows/private-security-bundle-free.yml` | `linux-shell` | linux | shell only |
...
| `.github/workflows/python-ci.yml` | `portable-shell` | linux, macos, windows | shell only |
...
| `.github/workflows/rust-ci.yml` | `portable-shell` | linux, macos, windows | shell only |
...
| `.github/workflows/sql-ci.yml` | `portable-shell` | linux, macos, windows | shell only |
| `.github/workflows/swift-ci.yml` | `macos-shell` | macos | shell only |
| `.github/workflows/terraform-ci.yml` | `portable-shell` | linux, macos, windows | shell only |
| `.github/workflows/web-ci.yml` | `portable-shell` | linux, macos, windows | shell only |
...
---
Generated from catalog/workflow-routing.yml.
