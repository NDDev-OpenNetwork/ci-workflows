...
gh attestation verify my-app-1.2.3.tar.gz -R NDDev-OpenNetwork/my-repo
...
```bash
scripts/export_repo_sbom.sh NDDev-OpenNetwork/my-repo dist/repository.sbom.spdx.json
```
