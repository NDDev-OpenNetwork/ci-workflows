...
[GitHub Security Advisory](https://github.com/NDDev-OpenNetwork/ci-workflows/security/advisories/new).
...
- **[Bug report](https://github.com/NDDev-OpenNetwork/ci-workflows/issues/new?template=bug_report.yml)**
  — a reusable workflow misbehaves (wrong result, unexpected failure, bad
  permission scope).
- **[Workflow request](https://github.com/NDDev-OpenNetwork/ci-workflows/issues/new?template=workflow_request.yml)**
  — propose a new reusable workflow or capability, and the tier(s) it targets.
- **[Tool update](https://github.com/NDDev-OpenNetwork/ci-workflows/issues/new?template=tool_update.yml)**
  — a pinned action or tool has a new version worth adopting.
- **[Docs gap](https://github.com/NDDev-OpenNetwork/ci-workflows/issues/new?template=docs_gap.yml)**
  — documentation is missing, wrong, or outdated.
- **[Security hardening](https://github.com/NDDev-OpenNetwork/ci-workflows/issues/new?template=security_hardening.yml)**
